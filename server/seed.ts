...
async function main() {
  ...
  await db.insert(schema.users).values([
    { id: "u-reader", username: "reader", password: "demo", displayName: "Ирина Смирнова", email: "reader@demo.local", roles: ["Читатель"], legalEntity: "ООО «Альфа»", department: "Операции", isAvailable: true, source: "ad", adAccountName: "smirnova_i", lastSyncAt: new Date(Date.now() - 3600_000) },
    { id: "u-author", username: "author", password: "demo", displayName: "Алексей Петров", email: "author@demo.local", roles: ["Автор", "Читатель"], legalEntity: "ООО «Альфа»", department: "Процессы", isAvailable: true, source: "ad", adAccountName: "petrov_a", lastSyncAt: new Date(Date.now() - 3600_000) },
    { id: "u-owner", username: "owner", password: "demo", displayName: "Мария Иванова", email: "owner@demo.local", roles: ["Владелец", "Автор"], legalEntity: "АО «Бета»", department: "Качество", isAvailable: true, source: "ad", adAccountName: "ivanova_m", lastSyncAt: new Date(Date.now() - 3600_000) },
    { id: "u-deputy", username: "deputy", password: "demo", displayName: "Сергей Кузнецов", email: "deputy@demo.local", roles: ["Заместитель владельца"], legalEntity: "АО «Бета»", department: "Качество", isAvailable: false, source: "ad", adAccountName: "kuznetsov_s", lastSyncAt: new Date(Date.now() - 7200_000), deactivatedAt: new Date(Date.now() - 86400_000 * 5) },
    { id: "u-kbadmin", username: "moderator", password: "demo", displayName: "Наталья Орлова", email: "moderator@demo.local", roles: ["Администратор"], legalEntity: "ООО «Альфа»", department: "База знаний", isAvailable: true, source: "local" },
    { id: "u-author-owner", username: "volkov", password: "demo", displayName: "Дмитрий Волков", email: "volkov@demo.local", roles: ["Автор", "Владелец"], legalEntity: "ООО «Альфа»", department: "Безопасность", isAvailable: true, source: "ad", adAccountName: "volkov_d", lastSyncAt: new Date(Date.now() - 3600_000) },
    { id: "u-reader-author", username: "kozlova", password: "demo", displayName: "Елена Козлова", email: "kozlova@demo.local", roles: ["Читатель", "Автор"], legalEntity: "АО «Бета»", department: "Финансы", isAvailable: true, source: "ad", adAccountName: "kozlova_e", lastSyncAt: new Date(Date.now() - 3600_000) },
    { id: "u-sec", username: "secadmin", password: "demo", displayName: "Вадим Соколов", email: "secadmin@demo.local", roles: ["Читатель"], legalEntity: "ООО «Альфа»", department: "Безопасность", isAvailable: true, source: "local" },
    { id: "u-aud", username: "auditor", password: "demo", displayName: "Ольга Миронова", email: "auditor@demo.local", roles: ["Читатель"], legalEntity: "АО «Бета»", department: "Аудит", isAvailable: true, source: "ad", adAccountName: "mironova_o", lastSyncAt: new Date(Date.now() - 3600_000) },
  ]);
